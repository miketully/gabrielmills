...
async function sliderImages() {
        ...
        const slugFormParam = getURLParameter(paramName)
         slugFormParam ? localStorage.setItem('installation-slug', slugFormParam) : null
        const title = localStorage.getItem('installation-slug') 

        if (title) {
                CHANNELS.paintings.slug = title
        } 
